(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))s(o);new MutationObserver(o=>{for(const i of o)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&s(r)}).observe(document,{childList:!0,subtree:!0});function t(o){const i={};return o.integrity&&(i.integrity=o.integrity),o.referrerPolicy&&(i.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?i.credentials="include":o.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(o){if(o.ep)return;o.ep=!0;const i=t(o);fetch(o.href,i)}})();const a="data:image/svg+xml,%3csvg%20width='171'%20height='126'%20viewBox='0%200%20171%20126'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cpath%20d='M0.412386%2016.666C0.328426%207.96051%207.31278%200.832773%2016.0182%200.739843L50.8476%200.368042C55.4039%200.319404%2059.1369%203.97358%2059.1855%208.52987C59.2338%2013.049%2062.9088%2016.6882%2067.4281%2016.6922L153.034%2016.768C161.602%2016.7756%20168.597%2023.6203%20168.791%2032.1857L170.521%20108.592C170.721%20117.422%20163.634%20124.696%20154.802%20124.724L17.1332%20125.168C8.46054%20125.196%201.3918%20118.218%201.30816%20109.546L0.412386%2016.666Z'%20fill='%235F5CF0'/%3e%3c/svg%3e",l="data:image/svg+xml,%3csvg%20width='69'%20height='85'%20viewBox='0%200%2069%2085'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3crect%20x='0.0546875'%20y='16.9419'%20width='47.2491'%20height='71.6357'%20rx='3.78598'%20transform='rotate(-20.0462%200.0546875%2016.9419)'%20fill='%23F1F1F1'/%3e%3crect%20x='10.551'%20y='30.1477'%20width='18.29'%20height='3.04833'%20transform='rotate(-20.0462%2010.551%2030.1477)'%20fill='%23454559'/%3e%3crect%20x='12.3806'%20y='35.1599'%20width='30.4833'%20height='3.04833'%20transform='rotate(-20.0462%2012.3806%2035.1599)'%20fill='%23454559'/%3e%3crect%20x='19.9568'%20y='55.9192'%20width='30.4833'%20height='3.04833'%20transform='rotate(-20.0462%2019.9568%2055.9192)'%20fill='%23454559'/%3e%3crect%20x='14.208'%20y='40.1704'%20width='30.4833'%20height='3.04833'%20transform='rotate(-20.0462%2014.208%2040.1704)'%20fill='%23454559'/%3e%3crect%20x='21.7839'%20y='60.9309'%20width='35.0558'%20height='3.04833'%20transform='rotate(-20.0462%2021.7839%2060.9309)'%20fill='%23454559'/%3e%3crect%20x='16.0376'%20y='45.1824'%20width='25.1487'%20height='3.04833'%20transform='rotate(-20.0462%2016.0376%2045.1824)'%20fill='%23454559'/%3e%3crect%20x='23.6138'%20y='65.9417'%20width='25.1487'%20height='3.04833'%20transform='rotate(-20.0462%2023.6138%2065.9417)'%20fill='%23454559'/%3e%3c/svg%3e",d="data:image/svg+xml,%3csvg%20width='79'%20height='96'%20viewBox='0%200%2079%2096'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3crect%20x='27.9023'%20y='0.557129'%20width='53.9171'%20height='81.7453'%20rx='3.78598'%20transform='rotate(19.8027%2027.9023%200.557129)'%20fill='%23F1F1F1'/%3e%3crect%20x='27.4421'%20y='19.8022'%20width='20.8711'%20height='3.47852'%20transform='rotate(19.8027%2027.4421%2019.8022)'%20fill='%23454559'/%3e%3crect%20x='25.3787'%20y='25.5295'%20width='34.7852'%20height='3.47852'%20transform='rotate(19.8027%2025.3787%2025.5295)'%20fill='%23454559'/%3e%3crect%20x='16.8394'%20y='49.2573'%20width='34.7852'%20height='3.47852'%20transform='rotate(19.8027%2016.8394%2049.2573)'%20fill='%23454559'/%3e%3crect%20x='23.3198'%20y='31.2581'%20width='34.7852'%20height='3.47852'%20transform='rotate(19.8027%2023.3198%2031.2581)'%20fill='%23454559'/%3e%3crect%20x='14.7756'%20y='54.9834'%20width='40.003'%20height='3.47852'%20transform='rotate(19.8027%2014.7756%2054.9834)'%20fill='%23454559'/%3e%3crect%20x='21.2561'%20y='36.9851'%20width='28.6978'%20height='3.47852'%20transform='rotate(19.8027%2021.2561%2036.9851)'%20fill='%23454559'/%3e%3crect%20x='12.7144'%20y='60.7117'%20width='28.6978'%20height='3.47852'%20transform='rotate(19.8027%2012.7144%2060.7117)'%20fill='%23454559'/%3e%3c/svg%3e";class c extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.render(),this.initializeElements(),this.setupEventListeners(),this.fileData={uploadedFile:null,error:!1,errorMsg:""}}render(){const e=`
		...
		`;this.shadowRoot.innerHTML=`
			<img src="${h}" class='throbber' alt='throbber' />
			<style>${e}</style>
		`}}customElements.define("loading-element",u);const f=async(n,e)=>{const t=new FormData;t.append("file",n),t.append("name",e);try{const s=await fetch("https://file-upload-server-mc26.onrender.com/api/v1/upload",{method:"POST",body:t});if(!s.ok){const i=await s.json();throw new Error(JSON.stringify({status:s.status,message:i.message||"Ошибка загрузки файла"}))}return await s.json()}catch(s){const{status:o,message:i}=JSON.parse(s.message);return{status:o,message:i}}};class m extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.render(),this.initializeElements(),this.uploadedFile=null,this.inputFileName=null,this.updateValues()}render(){const e=`
			.background_blur{
				position: fixed;
				display: flex;
				justify-content: center;
		...
		`;this.shadowRoot.innerHTML=`
			...
			<style>${e}</style>
		`}initializeElements(){this.closeButton=this.shadowRoot.querySelector(".btn_close_modal"),this.submitButton=this.shadowRoot.querySelector(".btn_submit"),this.backgroundDef=this.shadowRoot.querySelector(".background_color_default"),this.backgroundErr=this.shadowRoot.querySelector(".background_color_error"),this.backgroundSuc=this.shadowRoot.querySelector(".background_color_success"),this.fileDropzone=this.shadowRoot.querySelector("file-dropzone"),this.inputDesign=this.shadowRoot.querySelector("input-design");const e=()=>{this.updateValues(),this.uploadedFile.error?(this.backgroundErr.classList.add("active_error"),this.backgroundErr.classList.add("active_default"),this.shadowRoot.querySelector(".modal_description").textContent=this.uploadedFile.errorMsg):(this.backgroundErr.classList.remove("active_error"),this.backgroundErr.classList.remove("active_default"),this.shadowRoot.querySelector(".modal_description").textContent="Перед загрузкой дайте имя файлу");const s=this.uploadedFile.uploadedFile&&this.inputFileName;this.submitButton.disabled=!s,this.submitButton.style.backgroundColor=s?"#5F5CF0":"",this.submitButton.style.cursor=s?"pointer":"auto"},t=()=>{e()};this.fileDropzone.addEventListener("file-uploaded",t),this.inputDesign.addEventListener("input-change",t),e(),this.closeButton.addEventListener("click",()=>{this.dispatchEvent(new Event("close"))})}updateValues(){this.uploadedFile=this.fileDropzone.getUploadedFile(),this.inputFileName=this.inputDesign.getInputValue()}async handleSubmit(){this.shadowRoot.querySelector(".modal_title").textContent="Загрузка файла",this.shadowRoot.querySelector(".modal_description").style.display="none",this.shadowRoot.querySelector(".modal_content_content").style.display="none",this.shadowRoot.querySelector(".modal_footer").style.display="none",this.shadowRoot.querySelector(".modal").style.height="264px",this.shadowRoot.querySelector(".modal_content").style.top="57px",this.shadowRoot.querySelector(".modal_content_loading").style.display="flex";try{const e=await f(this.uploadedFile.uploadedFile,this.fileName);console.log(e),this.shadowRoot.querySelector(".modal_content_loading").style.display="none",this.shadowRoot.querySelector(".modal_content_request_response").style.display="flex",this.shadowRoot.querySelector(".modal_title").textContent="Файл успешно загружен",this.backgroundDef.classList.remove("active_default"),this.backgroundSuc.classList.add("active_success")}catch(e){e.status&&e.message&&(this.backgroundErr.classList.add("active_error"),this.shadowRoot.querySelector(".modal_title").textContent="Ошибка в загрузке файла")}}}customElements.define("modal-window",m);class g extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.isOpen=!1,this.handleOpenModal=this.handleOpenModal.bind(this),this.handleCloseModal=this.handleCloseModal.bind(this),this.render()}handleOpenModal(){this.isOpen=!0,this.render()}handleCloseModal(){this.isOpen=!1,this.render()}render(){const e=`
			.btn_open_modal {
					height: 56px;
					max-width: 277px;
					width: 100%;
		...
		`;this.shadowRoot.innerHTML=`
			...
			<style>${e}</style>
		`,this.shadowRoot.querySelector(".btn_open_modal").addEventListener("click",this.handleOpenModal),this.isOpen&&this.shadowRoot.querySelector("modal-window").addEventListener("close",this.handleCloseModal)}}customElements.define("btn-open",g);document.querySelector("#app").innerHTML=`
  <div class="app">
		<btn-open></btn-open>
		<div class="table"></div>
  </div>
